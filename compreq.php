...
$result = mysqli_query($con, "select * from company1 where Company_name like '".$_SESSION['Company_name']."'");
...
<body>
<nav class="navbar navbar-expand-sm bg-dark navbar-dark" style="height:85px; padding-bottom: 0px; margin: 10px 5px 10px 5px;">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="maestro2.png" class="rounded-circle" style="width: 15%; float: left; padding-top: 18px;" alt="MAESTRO"></a>
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#collapsibleNavbar">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse" id="collapsibleNavbar" style="align-items: right;">
          <a target="_blank" href="reqchange.php"><label style="text-align: right; font-size: 15px;">Click here to Request change</label></a>
    </div>
  </div>
  <a href="logoutdbms.php">Logout</a>
</nav>
<div class="heading">
